...
fun PostsDataItem.toDataBaseData() = FavoritesEntity(tittle = title , body = body, userId = userId, postId = id)
fun FavoritesEntity.toPostsData() = PostsDataItem(title = tittle , body = body, userId = userId, id = postId)
